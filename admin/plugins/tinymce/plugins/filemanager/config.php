...
$base_url="http://localhost:81/gallery(weblog)/admin/"; //url base of site if you want only relative url leave empty
$upload_dir = '/images/posts/'; // path from base_url to upload base dir
